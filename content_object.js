...
content = {
    ...
    "au-limitation-0": {
        ...
        parameterExplanation: "This patch assumes the existence of information! Don't just copy and paste!"
    },
    "au-limitation-1": {
        ...
        copyText: "{Limiting Party} [limits liability as much as the law allows to an amount equal to]({{url}}) to {Amount} to {Limited Party} for the {Liability Subject}, including liabilities caused by:\n\n- {risk 1};\n- {risk 2}; and\n- {risk 3}.",
        parameterExplanation: "This patch assumes the existence of information! Don't just copy and paste!"
    },
    "au-limitation-2": {
    ...
    "au-limitation-3": {
        ...
        copyText: "{Limiting Party} [covers all liabilities incurred]({{url}}) to {Limited Party} for the {Liability Subject}, including liabilities caused by:\n\n- {risk 1};\n- {risk 2}; and\n- {risk 3}.",
        parameterExplanation: "This patch assumes the existence of information! Don't just copy and paste!"
    },
}
